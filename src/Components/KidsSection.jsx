...
const products = [
  { id: 1, name: 'Lil Tomatoes Cotton Half', image: 'https://cdn.fcglcdn.com/brainbees/images/products/219x265/16439607a.webp', description: '1100/- only' },
  { id: 2, name: 'Black Print', image: 'https://cdn.fcglcdn.com/brainbees/images/products/219x265/16439627a.webp', description: '1800/- only' },
  { id: 3, name: 'white sky tshirt', image: 'https://cdn.fcglcdn.com/brainbees/images/products/219x265/16439642a.webp', description: '1000/- only' },
  { id: 4, name: 'Print tshirt', image: 'https://cdn.fcglcdn.com/brainbees/images/products/219x265/16439597a.webp', description: '800/- only' },
  { id: 5, name: 'sky blue tshirt', image: 'https://cdn.fcglcdn.com/brainbees/images/products/219x265/13171754a.webp', description: '1400/- only' },
  { id: 6, name: 'Blue hoodie', image: 'https://cdn.fcglcdn.com/brainbees/images/products/219x265/12699290a.webp', description: '1600/- only' },
  { id: 6, name: 'zebra tshirt', image: 'https://cdn.fcglcdn.com/brainbees/images/products/219x265/11665715a.webp', description: '1800/- only' },
  { id: 6, name: 'white tshirt', image: 'https://cdn.fcglcdn.com/brainbees/images/products/219x265/17574718a.webp', description: '1200/- only' },
  { id: 6, name: 'white lineing', image: 'https://cdn.fcglcdn.com/brainbees/images/products/219x265/15739977a.webp', description: '600/- only' },
  { id: 6, name: 'sky shirt', image: 'https://cdn.fcglcdn.com/brainbees/images/products/219x265/16254373a.webp', description: '500/- only' },
  { id: 6, name: 'Pent set', image: 'https://cdn.fcglcdn.com/brainbees/images/products/219x265/15613158a.webp', description: '2000/- only' },
  { id: 6, name: 'Yellow shirt', image: 'https://cdn.fcglcdn.com/brainbees/images/products/219x265/13171772a.webp', description: '2500/- only' },
];
    ...
    <div className="app-container bg-white text-black font-sans">
     <header className="header flex justify-between p-2">
      ...
      <div className="hero-section relative">
        <img 
          src="https://images.unsplash.com/photo-1505377059067-e285a7bac49b?q=80&w=1776&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" 
          alt="Men's Fashion" 
          className="w-full h-[600px] object-cover p-4"
        />
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center text-white ">
          <h2 className="text-xl md:text-2xl lg:text-3xl xl:text-6xl font-bold   rounded opacity-75 lg:pl-[80vh] pt-[20vh]">Kids.Section</h2>
...
// https://images.unsplash.com/photo-1630948468880-222a68e370d8?q=80&w=1925&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D